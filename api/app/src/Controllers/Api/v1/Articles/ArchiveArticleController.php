...
class ArchiveArticleController extends AbstractController {
    public function process(Request $request): Response
    {
        // Restriction : seuls admin et editor peuvent archiver
        ...
        if($article->status === 'archived') {
            return new Response(json_encode(['error' => 'déjà archivé']), 400, ['Content-Type' => 'application/json']);
        }
